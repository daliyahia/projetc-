...
employerui::employerui(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::employerui)
{
    ui->setupUi(this);
}

employerui::~employerui()
{
    delete ui;
}

void employerui::on_Boutton_Ajouter_clicked()
{
    QMessageBox msgBox;
...
void employerui::on_Boutton_Modifier_clicked()
{
...
void employerui::on_Boutton_tri_nom_clicked()
{
   Employer E1;
   ui->tab_employer->setModel(E1.tri_nom());
  }

void employerui::on_Boutton_tri_suivi_clicked()
{
    Employer E1;
    ui->tab_employer->setModel(E1.tri_suivi());
}

void employerui::on_Boutton_tri_ID_clicked()
{
    Employer E1;
    ui->tab_employer->setModel(E1.tri_ID());
}

void employerui::on_Boutton_rechecher_clicked()
{ Employer E1;
...
void employerui::on_Button_PDF_clicked()
{
...
void employerui::on_Button_statistique_clicked()
{
    Employer E;
        float s;
        QString m;
...
void employerui::on_Button_emp_mois_clicked()
{
    Employer E;
...
void employerui::on_pushButton_clicked()
{
