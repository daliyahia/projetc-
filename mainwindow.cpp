...
bool test=m.ajouter();
ui->tableView_2->setModel(etmp.afficher());//afichage
/*if (test)
{
...
void MainWindow::on_trimatrielsComboBox_currentIndexChanged(const QString &arg1)
{
    if(arg1 == "par défaut")
    {
       ui->tableView_2->setModel(etmp.trimatriels(arg1));
    }
...
{
    if(arg1!="")
    ui->tableView_2->setModel(etmp.recherchermatriels(arg1));
    else
        ui->tableView_2->setModel(etmp.recherchermatriels(arg1));}
...
void MainWindow::on_excel_clicked()
{
    ...
    ExportExcelObject obj(fileName, "matriels", ui->tableView_2);
